// ============================================================
// MeiraWatch - script.js (CLEAN SYNC ENGINE v2 + Cloudinary)
// ============================================================
...
// ============================================================
// VIDEO UPLOAD & STREAM (Dengan Cloudinary)
// ============================================================
...
async function uploadVideo() {
    ...
    // Tampilkan loading
    showSystemMessage('⏳ Mengupload video ke Cloudinary...');
    ...
    try {
        ...
        if (data.success) {
            ...
            showSystemMessage(`✅ Video berhasil diupload!`);
        } else {
...
console.log('✅ MeiraWatch siap digunakan! (Clean Sync Engine v2 + Cloudinary)');