...
// Konfigurasi Cloudinary (GANTI DENGAN DATA ANDA)
cloudinary.config({
    cloud_name: 'djj7d5qzi', // Ganti dengan Cloud Name Anda
    api_key: '256842112546763',       // Ganti dengan API Key Anda
    api_secret: 'ap0qbzsQsHf-rZp_bXoh_Y2LGAw'  // Ganti dengan API Secret Anda
});
...
// ============================================================
// VIDEO TRANSCODE (Untuk kompresi lokal, opsional)
// ============================================================
...
// ============================================================
// UPLOAD VIDEO - DENGAN CLOUDINARY
// ============================================================
...
app.post('/upload', upload.single('videoFile'), async (req, res) => {
    ...
    try {
        ...
        const result = await cloudinary.uploader.upload(req.file.path, {
            ...
            // Transcoding ke format yang lebih ringan (opsional)
            eager: [
                { width: 640, height: 360, crop: 'pad', video_codec: 'h264' },
                { width: 480, height: 270, crop: 'pad', video_codec: 'h264' }
            ]
        });

        // 2. Hapus file lokal setelah upload (hemat storage)
        try {
        ...
        // 3. Kirim response dengan URL video dari Cloudinary
        res.json({ 
            success: true, 
...
// ============================================================
// STREAM VIDEO (Fallback untuk video lokal)
// ============================================================
...
// ============================================================
// ROOM STATE (Sama seperti sebelumnya)
// ============================================================
